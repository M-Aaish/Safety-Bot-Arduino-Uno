...
os.system(f"{uv_bin} pip install --upgrade --python {venv_dir} depthai==2.28.0 opencv-python-headless python-socketio websocket-client requests imutils==0.5.3 concurrent-log-handler==0.9.16 blobconverter certifi")
